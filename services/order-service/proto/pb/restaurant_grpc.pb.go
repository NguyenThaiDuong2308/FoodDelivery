...
type RestaurantServiceClient interface {
	GetRestaurantInfoByID(ctx context.Context, in *GetRestaurantInfoByIDRequest, opts ...grpc.CallOption) (*GetRestaurantInfoByIDResponse, error)
...
func (c *restaurantServiceClient) GetRestaurantInfoByID(ctx context.Context, in *GetRestaurantInfoByIDRequest, opts ...grpc.CallOption) (*GetRestaurantInfoByIDResponse, error) {
	out := new(GetRestaurantInfoByIDResponse)
	err := c.cc.Invoke(ctx, "/proto.RestaurantService/GetRestaurantInfoByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restaurantServiceClient) GetMenuItem(ctx context.Context, in *GetMenuItemRequest, opts ...grpc.CallOption) (*GetMenuItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.RestaurantService/GetMenuItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RestaurantServiceServer interface {
	GetRestaurantInfoByID(context.Context, *GetRestaurantInfoByIDRequest) (*GetRestaurantInfoByIDResponse, error)
...
func (UnimplementedRestaurantServiceServer) GetRestaurantInfoByID(context.Context, *GetRestaurantInfoByIDRequest) (*GetRestaurantInfoByIDResponse, error) {
...
func _RestaurantService_GetRestaurantInfoByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRestaurantInfoByIDRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.RestaurantService/GetRestaurantInfoByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestaurantServiceServer).GetRestaurantInfoByID(ctx, req.(*GetRestaurantInfoByIDRequest))
	}
...
func _RestaurantService_GetMenuItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.RestaurantService/GetMenuItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
